    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('result', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='results.result')),
                ('result_detail', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, to='results.resultdetailmodel')),
            ],
        ),
    ]
